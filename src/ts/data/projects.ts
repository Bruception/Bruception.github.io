...
export const projects: Project[] = [
    {
        ...
        cardImage: `${BASE_IMAGE_URL}/personal-site.png`,
        description: 'The portfolio site you are viewing right now.',
        skills: ['TypeScript', 'Webpack', 'HTML', 'CSS'],
        links: [
            {
                type: 'source-code',
                uri: 'https://github.com/Bruception/Bruception.github.io',
            },
            {
                type: 'demo',
                uri: '/',
